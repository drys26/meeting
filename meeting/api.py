...
def get_meetings(start, end):
	...
	return frappe.db.sql(""" select timestamp(`date`,from_time) as start,
...
def make_orientation_meeting(doc,method):
	""" Create an orientaion meeting when a new user is added  """
	...
	# the System Manager might not have been permission to create a meeting
	meeting.flags.ignore_persmissions = True
	meeting.insert()
